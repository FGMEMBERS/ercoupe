...
####    Modified for DA20 Katana by Ron Jensen  ####
####    Syd Adams    ####
...
#var battery = Battery.new(volts,amps,amp_hours,charge_percent,charge_amps);
var battery = Battery.new(23,20,20,1.0,5.0);
# var alternator = Alternator.new("rpm-source",rpm_threshold,volts,amps);
var alternator1 = Alternator.new("/engines/engine[0]/rpm",1175.0,26.0,13.0);
...
var update_virtual_bus = func( dt ) {
   ...
   if ( ALT.getBoolValue() and (alternator1_volts > bus_volts) ) {
    ...
    var avionics_switch = props.globals.getNode("controls/avionics/power").getBoolValue();
    if (avionics_switch){
...
#    OutPuts.getNode("warning-lights",1).setValue(bus_volts * NORM);
